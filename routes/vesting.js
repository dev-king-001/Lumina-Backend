...
router.post('/calculate-weighted-average', async (req, res) => {
  try {
    ...
    const unvestedBalance = scheduleManager.sumUnvestedBalances(schedule1, schedule2, resultAssetCode);
    const weightedAverageCliff = scheduleManager.calculateWeightedAverageDate(schedule1, schedule2, 'cliff', resultAssetCode);
    const weightedAverageEnd = scheduleManager.calculateWeightedAverageDate(schedule1, schedule2, 'end', resultAssetCode);
